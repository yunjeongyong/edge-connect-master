...
def main(mode=None):    # 1: train, 2: test, 3: eval
    r"""starts the model
...
def load_config(mode=None):
    ...
    parser.add_argument('--model', type=int, default=3, help='1: edge model, 2: inpaint model, 3: edge-inpaint model, 4: joint model')
